// Unit tests for gadgets/cube_weight.h, run entirely in the clear via
...
int run_cube_weight_tests() {
    ...
    check(sess, "padding cube: weight = 0",
          make_cube(sess, "1111", "0000", /*pad=*/true), 0);
